                        ...
                        !isChannel && 
                          ( <Avatar className='h-10 w-10 rounded-full overflow-hidden'>
                                                      {contact.image ? (
                                                        ...
                                                        <div
                                                          className={` ${ selectedChatData && selectedChatData._id===contact._id ? "bg-[ffffff22] border border-white/70":getColor(contact.color)} uppercase h-10 w-10 text-2xl border-[1px] flex items-center justify-center rounded-full`}
                                                        >
                                                          {contact.firstName
